...
<div class="container">
  <form>
    ...
    <div class="row">
      <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-12 col-md-offset-3 form-group">
        <label for="message">Message</label><br>
        <!-- Interpolation between <textarea>{{ test }}</textarea> doesn't work!-->
        <textarea id="message" rows="5" class="form-control" v-model="messages"></textarea>
      </div>
    </div>
    <div class="row">
      <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-12 col-md-offset-3">
    ...
    <div class="row">
      <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-12 col-md-offset-3 from-group">
    ...
    <div class="row">
      <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-12 col-md-offset-3 from-group">
        <switch-app v-model="dataSwitch"></switch-app>
      </div>
    </div>
    <hr>
    <div class="row">
      <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-12 col-md-offset-3">
        <button class="btn btn-primary" @click.prevent="submitting">Submit!
        </button>
      </div>
    </div>
  </form>
    ...
    <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-12 col-md-offset-3">
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          ...
          <p style="white-space: pre">Message: {{ messages }}</p>
